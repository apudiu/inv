            ...
            <div class="card blue-grey darken-1">
                <div class="card-content white-text">
                    <div class="card-title">
                        ...
                        <div class="mr-0 float-right">
                            <a class="btn btn-small waves-effect blue-grey"
                               href="{{ route('clients.edit', $client->id) }}">Add Contact</a>
                        </div>
                    </div>
                        ...
                        <table class="responsive-table">
                            ...
                            @forelse($client->loadMissing('persons')->persons as $contact)
                                <tr>
                                    ...
                                    <td>{{ $contact->email }}</td>
                                    <td>{{ formatDateTime($contact->created_at, true) }}</td>
                                    <td>
                                        <a href="{{ route('clients.show', $contact->id) }}"
                                           class='btn btn-small blue-grey waves-effect'>View</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="center">No contacts available</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
